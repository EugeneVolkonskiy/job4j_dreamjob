...
public class VacancyControllerTest {
    ...
    @Test
    public void whenFindByIdSuccessfullyThanGetVacanciesPage() {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
        var city1 = new City(1, "Москва");
        var city2 = new City(2, "Санкт-Петербург");
        var expectedCities = List.of(city1, city2);
    ...
    @Test
    public void whenVacancyNotFoundByIdThanGetErrorPageWithMessage() {
    ...
    @Test
    public void whenUpdatedSuccessfullyThanRedirectToVacanciesPage() throws IOException {
        var vacancy = new Vacancy(1, "test1", "desc1", now(), true, 1, 2);
        var fileDto = new FileDto(testFile.getOriginalFilename(), testFile.getBytes());
        var vacancyArgumentCaptor = ArgumentCaptor.forClass(Vacancy.class);
        var fileDtoArgumentCaptor = ArgumentCaptor.forClass(FileDto.class);
    ...
    @Test
    public void whenVacancyNotUpdatedThanGetErrorPageWithMessage() {
        var expectedMessage = "Вакансия с указанным идентификатором не найдена";
    ...
    @Test
    public void whenVacancyNotUpdatedThanExceptionThrownAndGetErrorPage() {
    ...
    @Test
    public void whenDeletedSuccessfullyThanRedirectToVacanciesPage() {
    ...
    @Test
    public void whenVacancyNotDeletedThanGetErrorPage() {
