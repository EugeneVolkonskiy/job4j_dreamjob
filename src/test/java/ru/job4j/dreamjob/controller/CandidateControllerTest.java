...
public class CandidateControllerTest {
    ...
    @Test
    public void whenFindByIdSuccessfullyThanGetCandidatesPage() {
        var candidate = new Candidate(1, "test1", "desc1", now(), 1, 2);
        var city1 = new City(1, "Москва");
        var city2 = new City(2, "Санкт-Петербург");
        var expectedCities = List.of(city1, city2);
    ...
    @Test
    public void whenCandidateNotFoundByIdThanGetErrorPageWithMessage() {
    ...
    @Test
    public void whenUpdatedSuccessfullyThanRedirectToCandidatesPage() throws IOException {
        var candidate = new Candidate(1, "test1", "desc1", now(), 1, 2);
        var fileDto = new FileDto(testFile.getOriginalFilename(), testFile.getBytes());
        var candidateArgumentCaptor = ArgumentCaptor.forClass(Candidate.class);
        var fileDtoArgumentCaptor = ArgumentCaptor.forClass(FileDto.class);
        when(candidateService.save(any(Candidate.class), any(FileDto.class))).thenAnswer(i -> i.getArguments()[0]);
    ...
    @Test
    public void whenCandidateNotUpdatedThanGetErrorPageWithMessage() {
        var expectedMessage = "Кандидат с указанным идентификатором не найден";
    ...
    @Test
    public void whenCandidateNotUpdatedThanExceptionThrownAndGetErrorPage() {
    ...
    @Test
    public void whenDeletedSuccessfullyThanRedirectToCandidatesPage() {
    ...
    @Test
    public void whenCandidateNotDeletedThanGetErrorPage() {
